/*
  ...
  This code was derived from the public domain code in 
  RFC 1321.
*/
 ...
 */
static void 
MD5Transform(unsigned state[4], const unsigned char block[64])
{
...
/* Encodes input (UINT4) into output (unsigned char). Assumes len is
  a multiple of 4. */
static void 
Encode(unsigned char *output, const unsigned *input, unsigned int len)
{
	unsigned int i, j;
